  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-green-200 data-[active=true]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
